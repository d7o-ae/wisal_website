      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="bg-red-50 p-8 rounded-2xl border border-red-100">
          ...
          <p className="text-wisal-secondary leading-relaxed text-lg">
            تعتمد العديد من المدارس على وسائل غير منظمة مثل مجموعات الواتساب أو الرسائل المتفرقة، مما يؤدي إلى ضياع المعلومات، ضعف التفاعل، وتأخر وصول الإشعارات المهمة.
          </p>
        </div>
